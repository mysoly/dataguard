...
from careons_deid.processors.text_processor import analyze as _analyze, guard as _guard
from careons_deid.processors.doc_processor import (
...
def custom_pattern(
    ...
    Example::
        ...
        from careons_deid import guard, custom_pattern
...
from careons_deid.processors.doc_processor import UnsupportedFormatError
