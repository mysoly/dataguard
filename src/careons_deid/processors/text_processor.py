"""
careons_deid.processors.text_processor
--------------------------------------
...
Public interface (via careons_deid.analyze / careons_deid.guard):
...
from careons_deid.core import analyzer as _analyzer
from careons_deid.core import guard as _guard
from careons_deid.guard_engine.guard_engine import _VALID_MODES
